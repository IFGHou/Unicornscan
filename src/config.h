 ...
 */
#define HAVE_PROC_NET_ROUTE 1

/* may not be used, if using MAC */
#define NOPRIV_USER "unicornscan"
...
#define HAVE_PCAP_SET_NONBLOCK 1
...
#define SENDERNAME "unisend"
#define TARGETNAME "unicornscan"
#define LISTENERNAME "unilisten"
